...
public interface TratamientoRepository extends JpaRepository<Tratamiento, Long> {
    ...
    @Query("SELECT new org.example.chillingdogspage.Entidad.MedicamentosMes(d.nombre, COUNT(*)) FROM Tratamiento t JOIN t.droga d GROUP BY d.id ORDER BY COUNT(*) DESC LIMIT 3")
